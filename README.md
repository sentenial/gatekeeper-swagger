## Welcome to the gatekeeper swagger specification

Gatekeeper is the security gateway in Sentenial.
...
#### API Docs
Our API specification is available at the following link. [Click here for the API documentation](https://sentenial.github.io/gatekeeper-swagger/docs/redoc.html). 
